  ...
  return (
    <div className="sub_div">
      <div className="sub_menu">
        ...
        <ul>
          <li ><Link href='introduce'>FX마진거래</Link></li>
          <li className="active"><Link href='howtoinvestment'>FX투자방법</Link></li>
        </ul>
      </div>
      <div className="sub_page">
        <h3 className="tit_01">FX투자방법</h3>
        <table className="tb_01" width="100%" >
            <tr>
              <th>입금계좌</th>
              <td>1. 국민은행 000000-00-00000 주식회사 차트파트너스</td>
            </tr>
            <tr>
              <th>예금주</th>
              <td>
